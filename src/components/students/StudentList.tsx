...
import { Pencil, Trash2, Eye, UserCheck, UserX, Calendar } from "lucide-react"
            ...
            {students.map((student) => {
              ...
              return (
                <tr key={student.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {student.belt ? (
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getBeltColor(student.belt)}`}>
              ...
              <div className="space-y-1 mb-3">
                {student.belt && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`px-2 py-1 text-xs font-semibold rounded-full ${getBeltColor(student.belt)}`}>
                      {student.belt.charAt(0).toUpperCase() + student.belt.slice(1)}
                    </span>
                  </div>
                )}
